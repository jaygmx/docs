...
‘status=LEVEL’ Transfer information is normally output to stderr upon
...
‘iflag=FLAG\[,FLAG\]...’ Access the input file using the flags specified
...
Sending an ‘INFO’ signal (or ‘USR1’ signal where that is unavailable) to
